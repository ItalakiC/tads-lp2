...
public class UsuarioService {
    ...
    public Usuario buscarPorId(Long id) {
       ...
       if (usuarioOptional.isPresent()) {
        ...
        throw new RegraDeNegocioException("Usuário não encontrada: " + id);
    }


    public void validarEmail (String email) {
        Optional<Usuario> usuarioOtional = this.usuarioRepository.buscarPorEmail(email);

        if (usuarioOtional.isPresent()) {
